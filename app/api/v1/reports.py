...
# Connection to the analytics_llm PostgreSQL database
# Contains all tables: sales_analytics, stock_gw, gwanalytics
# Uses environment variables from .env file via Settings
ANALYTICS_DB_URL = settings.analytics_database_url
